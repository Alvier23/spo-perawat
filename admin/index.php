        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="master-data.php" class="nav-link">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            <h2 style="text-align: center">Selamat datang di Halaman Administrator SOP Keperawatan</h2>
                            <div class="text-center">
                                <img src="../assets/img/admin.png" class="img-fluid" width="400">
                            </div>
                        </div>
                        <!-- /.col-md-6 -->
                    </div>
